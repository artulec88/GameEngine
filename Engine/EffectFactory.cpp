...
Engine::Effects::Effect<Math::Real>* Engine::Effects::EffectFactory::GetSingleValueEffect(EffectType effectType, unsigned int variant)
{
	...
	{
		WARNING_LOG_ENGINE("Incorrect single value effect variant (%d) specified. The correct variant must be in range [1; %d].", variant, m_singleValueEffects.size());
...
Engine::Effects::Effect<Math::Vector2D>* Engine::Effects::EffectFactory::GetVec2DEffect(EffectType effectType, unsigned int variant)
{
	...
	{
		WARNING_LOG_ENGINE("Incorrect vector 2D effect variant (%d) specified. The correct variant must be in range [1; %d].", variant, m_vec2DEffects.size());
...
Engine::Effects::Effect<Math::Vector3D>* Engine::Effects::EffectFactory::GetVec3DEffect(EffectType effectType, unsigned int variant)
{
	...
	{
		WARNING_LOG_ENGINE("Incorrect vector 3D effect variant (%d) specified. The correct variant must be in range [1; %d].", variant, m_vec3DEffects.size());
