...
void engine::StaticCameraBehavior::Handle(rendering::Camera* camera, actions::Action action)
{
	WARNING_LOG_ENGINE("Handling action ", action, " by the static camera.");
}

void engine::StaticCameraBehavior::Handle(rendering::Camera* camera, states::State state)
{
	WARNING_LOG_ENGINE("Handling state ", state, " by the static camera.");
}

void engine::StaticCameraBehavior::Handle(rendering::Camera* camera, ranges::Range range, math::Real value)
{
...
void engine::RotationCameraBehavior::Handle(rendering::Camera* camera, actions::Action action)
{
	WARNING_LOG_ENGINE("Handling action ", action, " by the rotation camera.");
}

void engine::RotationCameraBehavior::Handle(rendering::Camera* camera, states::State state)
{
	WARNING_LOG_ENGINE("Handling state ", state, " by the rotation camera.");
}

void engine::RotationCameraBehavior::Handle(rendering::Camera* camera, ranges::Range range, math::Real value)
{
...
void engine::MovementCameraBehavior::Handle(rendering::Camera* camera, actions::Action action)
{
	WARNING_LOG_ENGINE("Handling action ", action, " by the movement camera.");
}

void engine::MovementCameraBehavior::Handle(rendering::Camera* camera, states::State state)
{
	WARNING_LOG_ENGINE("Handling state ", state, " by the movement camera.");
}

void engine::MovementCameraBehavior::Handle(rendering::Camera* camera, ranges::Range range, math::Real value)
{
