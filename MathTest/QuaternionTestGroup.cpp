...
void QuaternionTestConjugate::StartTest()
{
	...
	CHECK_CONDITION_ALWAYS_MATH_TEST(conjugate == m_expectedConjugate, Utility::ERR,
	...
	CHECK_CONDITION_ALWAYS_MATH_TEST(conjugate.Conjugate() == m_quaternion, Utility::ERR,
...
void QuaternionTestAddOperator::StartTest()
{
	...
	CHECK_CONDITION_ALWAYS_MATH_TEST(sumQuaternion == m_expectedSumQuaternion, Utility::ERR,
...
void QuaternionTestSubtractOperator::StartTest()
{
	...
	CHECK_CONDITION_ALWAYS_MATH_TEST(subtractQuaternion == m_expectedSubtractQuaternion, Utility::ERR,
...
void QuaternionTestDivideOperator::StartTest()
{
	...
	CHECK_CONDITION_ALWAYS_MATH_TEST(divideQuaternion == m_expectedDivideQuaternion, Utility::ERR,
	...
	m_expectedNormalizedQuaternion(expectedNormalizedQuaternion)
{
	...
	CHECK_CONDITION_ALWAYS_MATH_TEST(m_expectedNormalizedQuaternion.IsNormalized(), Utility::ERR,
...
void QuaternionTestNormalize::StartTest()
{
	...
	CHECK_CONDITION_ALWAYS_MATH_TEST(normalizedQuaternion == m_expectedNormalizedQuaternion, Utility::ERR,
		...
		m_expectedNormalizedQuaternion.ToString().c_str());
	CHECK_CONDITION_ALWAYS_MATH_TEST(normalizedQuaternion.IsNormalized(), Utility::ERR,
		"Calculated normalized quaternion %s is in fact not normalized.",
		normalizedQuaternion.ToString().c_str());

	m_quaternion.Normalize();
	CHECK_CONDITION_ALWAYS_MATH_TEST(m_quaternion == m_expectedNormalizedQuaternion, Utility::ERR,
	...
	CHECK_CONDITION_ALWAYS_MATH_TEST(m_quaternion.IsNormalized(), Utility::ERR,
		"Calculated normalized quaternion %s is in fact not normalized.",
...
void QuaternionTestNlerp::StartTest()
{
	...
	CHECK_CONDITION_ALWAYS_MATH_TEST(nlerpQuaternion == m_expectedNlerpQuaternion, Utility::ERR,
...
void QuaternionTestSlerp::StartTest()
{
	...
	CHECK_CONDITION_ALWAYS_MATH_TEST(slerpQuaternion == m_expectedSlerpQuaternion, Utility::ERR,
...
void QuaternionTestForward::StartTest()
{
	...
	CHECK_CONDITION_ALWAYS_MATH_TEST(forwardVector == m_expectedForwardVector, Utility::ERR,
...
void QuaternionTestUp::StartTest()
{
	...
	CHECK_CONDITION_ALWAYS_MATH_TEST(upVector == m_expectedUpVector, Utility::ERR,
...
void QuaternionTestRight::StartTest()
{
	...
	CHECK_CONDITION_ALWAYS_MATH_TEST(rightVector == m_expectedRightVector, Utility::ERR,
...
void QuaternionTestBack::StartTest()
{
	...
	CHECK_CONDITION_ALWAYS_MATH_TEST(backVector == m_expectedBackVector, Utility::ERR,
...
void QuaternionTestDown::StartTest()
{
	...
	CHECK_CONDITION_ALWAYS_MATH_TEST(downVector == m_expectedDownVector, Utility::ERR,
...
void QuaternionTestLeft::StartTest()
{
	...
	CHECK_CONDITION_ALWAYS_MATH_TEST(leftVector == m_expectedLeftVector, Utility::ERR,
...
void QuaternionTestRotationMatrix::StartTest()
{
	...
	CHECK_CONDITION_ALWAYS_MATH_TEST(rotationMatrix == m_expectedRotationMatrix, Utility::ERR,
