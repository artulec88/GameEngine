...
void Utility::CutToTokens(const string& str, vector<string>& tokens, char delim)
{
...
void Utility::CutToTokens(const string& str, vector<string>& tokens, char* delim, int delimCount)
{
	//stringstream ss(str);
	//string temp = "";
	//ss >> temp;
