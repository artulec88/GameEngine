					 ...
					 )
{
	...
	case DLL_PROCESS_ATTACH:
		DEBUG_LOG_UTILITY("The Utility DLL is being ", ((lpReserved == nullptr) ? "dynamically" : "statically"), " loaded into the virtual address space of the current process");
		break;
	...
	case DLL_PROCESS_DETACH:
		DEBUG_LOG_UTILITY("The Utility DLL is being detached from the current process. ", ((lpReserved == nullptr) ? "" : "The process is terminating."));
		break;
	default:
