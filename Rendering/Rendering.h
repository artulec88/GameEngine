...
#define CRITICAL_LOG_RENDERING(message, ...) CRITICAL_LOG("Rendering", message, ##__VA_ARGS__)
#define EMERGENCY_LOG_RENDERING(message, ...) EMERGENCY_LOG("Rendering", message, ##__VA_ARGS__)
#define ERROR_LOG_RENDERING(message, ...) ERROR_LOG("Rendering", message, ##__VA_ARGS__)
#define WARNING_LOG_RENDERING(message, ...) WARNING_LOG("Rendering", message, ##__VA_ARGS__)
#define NOTICE_LOG_RENDERING(message, ...) NOTICE_LOG("Rendering", message, ##__VA_ARGS__)
#define INFO_LOG_RENDERING(message, ...) INFO_LOG("Rendering", message, ##__VA_ARGS__)
#define DEBUG_LOG_RENDERING(message, ...) DEBUG_LOG("Rendering", message, ##__VA_ARGS__)
#define DELOCUST_LOG_RENDERING(message, ...) DELOCUST_LOG("Rendering", message, ##__VA_ARGS__)

#define CHECK_CONDITION_RENDERING(expr, logLevel, message, ...) CHECK_CONDITION(expr, "Rendering", logLevel, message, ##__VA_ARGS__)
#define CHECK_CONDITION_ALWAYS_RENDERING(expr, logLevel, message, ...) CHECK_CONDITION_ALWAYS(expr, "Rendering", logLevel, message, ##__VA_ARGS__)
#define CHECK_CONDITION_EXIT_RENDERING(expr, logLevel, message, ...) CHECK_CONDITION_EXIT(expr, "Rendering", logLevel, message, ##__VA_ARGS__)
#define CHECK_CONDITION_EXIT_ALWAYS_RENDERING(expr, logLevel, message, ...) CHECK_CONDITION_EXIT_ALWAYS(expr, "Rendering", logLevel, message, ##__VA_ARGS__)
#define CHECK_CONDITION_RETURN_VOID_RENDERING(expr, logLevel, message, ...) CHECK_CONDITION_RETURN_VOID(expr, "Rendering", logLevel, message, ##__VA_ARGS__)
#define CHECK_CONDITION_RETURN_VOID_ALWAYS_RENDERING(expr, logLevel, message, ...) CHECK_CONDITION_RETURN_VOID_ALWAYS(expr, "Rendering", logLevel, message, ##__VA_ARGS__)
#define CHECK_CONDITION_RETURN_RENDERING(expr, returnValue, logLevel, message, ...) CHECK_CONDITION_RETURN(expr, returnValue, "Rendering", logLevel, message, ##__VA_ARGS__)
#define CHECK_CONDITION_RETURN_ALWAYS_RENDERING(expr, returnValue, logLevel, message, ...) CHECK_CONDITION_RETURN_ALWAYS(expr, returnValue, "Rendering", logLevel, message, ##__VA_ARGS__)
