...
Rendering::CameraBuilder::CameraBuilder() :
	...
	M_DEFAULT_CAMERA_POS(GET_CONFIG_VALUE_RENDERING("defaultCameraPosX", 0.0f), GET_CONFIG_VALUE_RENDERING("defaultCameraPosY", 0.0f), GET_CONFIG_VALUE_RENDERING("defaultCameraPosZ", 0.0f)),
