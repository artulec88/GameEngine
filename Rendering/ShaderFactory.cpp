...
{
	m_shaderType2ShaderMap.emplace(ShaderIDs::AMBIENT, Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultAmbientLightShader", "forward-ambient.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::AMBIENT_TERRAIN, Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultAmbientLightTerrainShader", "forward-ambient-terrain.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::AMBIENT_FOG_LINEAR_PLANE_BASED, Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultAmbientLightFogLinearPlaneBasedShader", "forward-ambient-fog-linear-plane-based.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::AMBIENT_FOG_EXPONENTIAL_PLANE_BASED, Shader(m_shadersDirectory,
	...
	m_shaderType2ShaderMap.emplace(ShaderIDs::AMBIENT_FOG_LINEAR_RANGE_BASED, Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultAmbientLightFogLinearRangeBasedShader", "forward-ambient-fog-linear-range-based.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::AMBIENT_FOG_EXPONENTIAL_RANGE_BASED, Shader(m_shadersDirectory,
	...
	m_shaderType2ShaderMap.emplace(ShaderIDs::AMBIENT_TERRAIN_FOG_LINEAR_PLANE_BASED, Shader(m_shadersDirectory,
	...
	m_shaderType2ShaderMap.emplace(ShaderIDs::AMBIENT_TERRAIN_FOG_EXPONENTIAL_PLANE_BASED, Shader(m_shadersDirectory,
	...
	m_shaderType2ShaderMap.emplace(ShaderIDs::AMBIENT_TERRAIN_FOG_LINEAR_RANGE_BASED, Shader(m_shadersDirectory,
	...
	m_shaderType2ShaderMap.emplace(ShaderIDs::AMBIENT_TERRAIN_FOG_EXPONENTIAL_RANGE_BASED, Shader(m_shadersDirectory,
	...
	m_shaderType2ShaderMap.emplace(ShaderIDs::SHADOW_MAP, Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultShadowMapShader", "shadowMapGenerator.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::SHADOW_MAP_CUBE, Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultCubeShadowMapShader", "CubeShadowMapGenerator.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::FILTER_NULL, Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultNullFilterShader", "Filter-null.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::FILTER_GAUSSIAN_BLUR, Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultGaussBlurFilterShader", "filter-gaussBlur7x1.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::FILTER_FXAA, Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultFxaaFilterShader", "filter-fxaa.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::SKYBOX, Rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultSkyboxShader", "skybox-shader.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::SKYBOX_PROCEDURAL, Rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultSkyboxProceduralShader", "skybox-procedural-shader.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::TEXT_SIMPLE, Rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultTextShader", "text-shader.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::TEXT, Rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultTextShader2", "text-shader-2.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::WATER, Rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultWaterShader", "water-shader.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::WATER_NO_DIRECTIONAL_LIGHT, Rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultWaterNoDirectionalLightShader", "water-no-directional-light-shader.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::BILLBOARD, Rendering::Shader(m_shadersDirectory,
	...
	m_shaderType2ShaderMap.emplace(ShaderIDs::DIRECTIONAL_LIGHT_TERRAIN, Rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultDirectionalLightTerrainShader", "forward-directional-terrain.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::DIRECTIONAL_LIGHT_NO_SHADOWS, Rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultDirectionalLightNoShadowShader", "forward-directional-no-shadows.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::DIRECTIONAL_LIGHT_TERRAIN_NO_SHADOWS, Rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultDirectionalLightNoShadowTerrainShader", "forward-directional-terrain-no-shadows.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::POINT_LIGHT, Rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultPointLightShader", "forward-point.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::POINT_LIGHT_TERRAIN, Rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultPointLightTerrainShader", "forward-point-terrain.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::POINT_LIGHT_NO_SHADOWS, Rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultPointLightNoShadowShader", "forward-point-no-shadows.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::POINT_LIGHT_TERRAIN_NO_SHADOWS, Rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultPointLightNoShadowTerrainShader", "forward-point-terrain-no-shadows.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::SPOT_LIGHT, Rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultSpotLightShader", "forward-spot.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::SPOT_LIGHT_TERRAIN, Rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultSpotLightTerrainShader", "forward-spot-terrain.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::SPOT_LIGHT_NO_SHADOWS, Rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultSpotLightNoShadowShader", "forward-spot-no-shadows.glsl")));
	m_shaderType2ShaderMap.emplace(ShaderIDs::SPOT_LIGHT_TERRAIN_NO_SHADOWS, Rendering::Shader(m_shadersDirectory,
