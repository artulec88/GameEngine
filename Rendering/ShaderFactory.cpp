	...
	//{ shader_ids::AMBIENT_TERRAIN, std::move(Shader(GET_CONFIG_VALUE_STR_RENDERING("ambientLightTerrainShader", "forward-ambient-terrain")))} })
{
	...
	m_shaderType2ShaderMap.emplace(shader_ids::SKYBOX, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultSkyboxShader", "skybox-shader.glsl")));
	m_shaderType2ShaderMap.emplace(shader_ids::SKYBOX_PROCEDURAL, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultSkyboxProceduralShader", "skybox-procedural-shader.glsl")));
	m_shaderType2ShaderMap.emplace(shader_ids::TEXT_SIMPLE, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultTextShader", "text-shader.glsl")));
	m_shaderType2ShaderMap.emplace(shader_ids::TEXT, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultTextShader2", "text-shader-2.glsl")));
	m_shaderType2ShaderMap.emplace(shader_ids::WATER, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultWaterShader", "water-shader.glsl")));
	m_shaderType2ShaderMap.emplace(shader_ids::WATER_NO_DIRECTIONAL_LIGHT, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultWaterNoDirectionalLightShader", "water-no-directional-light-shader.glsl")));
	m_shaderType2ShaderMap.emplace(shader_ids::BILLBOARD, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultBillboardShader", "billboard-shader.glsl")));
	m_shaderType2ShaderMap.emplace(shader_ids::PARTICLES, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultParticleShader", "particle-shader.glsl")));
	m_shaderType2ShaderMap.emplace(shader_ids::PARTICLES_COLORS, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultParticleColorShader", "particle-shader-color.glsl"))),
	m_shaderType2ShaderMap.emplace(shader_ids::GUI, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultGuiShader", "gui-shader.glsl")));
	m_shaderType2ShaderMap.emplace(shader_ids::DIRECTIONAL_LIGHT, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultDirectionalLightShader", "forward-directional.glsl")));
	m_shaderType2ShaderMap.emplace(shader_ids::DIRECTIONAL_LIGHT_TERRAIN, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultDirectionalLightTerrainShader", "forward-directional-terrain.glsl")));
	m_shaderType2ShaderMap.emplace(shader_ids::DIRECTIONAL_LIGHT_NO_SHADOWS, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultDirectionalLightNoShadowShader", "forward-directional-no-shadows.glsl")));
	m_shaderType2ShaderMap.emplace(shader_ids::DIRECTIONAL_LIGHT_TERRAIN_NO_SHADOWS, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultDirectionalLightNoShadowTerrainShader", "forward-directional-terrain-no-shadows.glsl")));
	m_shaderType2ShaderMap.emplace(shader_ids::POINT_LIGHT, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultPointLightShader", "forward-point.glsl")));
	m_shaderType2ShaderMap.emplace(shader_ids::POINT_LIGHT_TERRAIN, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultPointLightTerrainShader", "forward-point-terrain.glsl")));
	m_shaderType2ShaderMap.emplace(shader_ids::POINT_LIGHT_NO_SHADOWS, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultPointLightNoShadowShader", "forward-point-no-shadows.glsl")));
	m_shaderType2ShaderMap.emplace(shader_ids::POINT_LIGHT_TERRAIN_NO_SHADOWS, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultPointLightNoShadowTerrainShader", "forward-point-terrain-no-shadows.glsl")));
	m_shaderType2ShaderMap.emplace(shader_ids::SPOT_LIGHT, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultSpotLightShader", "forward-spot.glsl")));
	m_shaderType2ShaderMap.emplace(shader_ids::SPOT_LIGHT_TERRAIN, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultSpotLightTerrainShader", "forward-spot-terrain.glsl")));
	m_shaderType2ShaderMap.emplace(shader_ids::SPOT_LIGHT_NO_SHADOWS, rendering::Shader(m_shadersDirectory,
		GET_CONFIG_VALUE_STR_RENDERING("defaultSpotLightNoShadowShader", "forward-spot-no-shadows.glsl")));
	m_shaderType2ShaderMap.emplace(shader_ids::SPOT_LIGHT_TERRAIN_NO_SHADOWS, rendering::Shader(m_shadersDirectory,
