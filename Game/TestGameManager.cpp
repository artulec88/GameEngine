...
void TestGameManager::Load()
{
	...
	playerNode->AddComponent(new Engine::ParticleGeneratorComponent(this, new Rendering::ParticleTexture(GET_CONFIG_VALUE_STR("particleGeneratorTextureFire", "particleFire.png"), 4), 10, 0.05f, 0.0f, 1.2f));
	m_resourcesLoaded += 2;
